...
const Hero = () => {
  ...
  return (
    <section
      ...
      id="inicio"
      title="Inicio"
      className="min-h-screen flex items-center justify-center pt-16 bg-background dark:bg-zinc-900 transition-colors"
    >
      <div
        style={heroStyle}
      ...
      <AnimatedElement
        animation="fade-up"
        delay={0.8}
        className="absolute bottom-5 md:translate-y-10 left-1/2 -translate-x-1/2"
      >
        <a
          href="#sobre-mi"
